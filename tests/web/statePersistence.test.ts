...
describe('statePersistence', () => {
	...
	describe('saveExpandedCommitLoading', () => {
		it('should set expanded commit with loading state', () => {
			...
			vm.runInContext('saveExpandedCommitLoading(mockView, 5, "def456", testCommitElem, null, null)', ctx);
		...
		it('should set expanded commit with compare hash', () => {
			...
			vm.runInContext('saveExpandedCommitLoading(mockView, 3, "abc", testCommitElem, "xyz", testCompareElem)', ctx);
