import { LifeCycleStage, generateNonce, getDataDirectory, getLifeCycleStateInDirectory, saveLifeCycleStateInDirectory, sendQueue } from '../src/life-cycle/utils';
...
describe('life-cycle/utils', () => {
	...
	describe('saveLifeCycleStateInDirectory', () => {
		it('Should resolve without error (no-op)', async () => {
			await expect(saveLifeCycleStateInDirectory('/some/dir', {
				previous: null,
