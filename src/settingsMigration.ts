...
const MIGRATIONS: { oldKey: string; newKey: string }[] = [
	...
	{ oldKey: 'commitDetailsViewFileTreeCompactFolders', newKey: 'commitDetailsView.fileView.fileTree.compactFolders' },
	...
	{ oldKey: 'includeCommitsMentionedByReflogs', newKey: 'repository.includeCommitsMentionedByReflogs' },
	...
	{ oldKey: 'muteCommitsThatAreNotAncestorsOfHead', newKey: 'repository.commits.mute.commitsThatAreNotAncestorsOfHead' },
	...
	{ oldKey: 'showCommitsOnlyReferencedByTags', newKey: 'repository.showCommitsOnlyReferencedByTags' },
	...
	{ oldKey: 'combineLocalAndRemoteBranchLabels', newKey: 'referenceLabels.combineLocalAndRemoteBranchLabels' },
