class GitGraphView {
  ...
  public getGitBranches(): ReadonlyArray<string> {
    return this.gitBranches;
  }
  public getGitBranchHead(): string | null {
    return this.gitBranchHead;
  }
  public getGitRemotes(): ReadonlyArray<string> {
    return this.gitRemotes;
  }
  public getGitRepos(): GG.GitRepoSet {
    return this.gitRepos;
  }
  public getGitStashes(): ReadonlyArray<GG.GitStash> {
    return this.gitStashes;
  }
  public getGitTags(): ReadonlyArray<string> {
    return this.gitTags;
  }
  public getCurrentRepo(): string {
    return this.currentRepo;
  }
  public getCurrentRepoLoading(): boolean {
    return this.currentRepoLoading;
  }
  public getCommitHead(): string | null {
    return this.commitHead;
  }
  public getCommitLookup(): Readonly<{ [hash: string]: number }> {
    return this.commitLookup;
  }
  public getAvatars(): AvatarImageCollection {
    return this.avatars;
  }
  public getCurrentBranches(): string[] | null {
    return this.currentBranches;
  }
  public getMoreCommitsAvailable(): boolean {
    return this.moreCommitsAvailable;
  }
  public getMaxCommits(): number {
  ...
  public getBranchDropdown(): Dropdown {
    return this.branchDropdown;
  }
  public getRepoDropdown(): Dropdown {
    return this.repoDropdown;
  }
  public getFindWidget(): FindWidget {
    return this.findWidget;
  }
  public getSettingsWidget(): SettingsWidget {
    return this.settingsWidget;
  }
  public getShowRemoteBranchesElem(): HTMLInputElement {
    return this.showRemoteBranchesElem;
  }
  public getExpandedCommit(): ExpandedCommit | null {
    return this.expandedCommit;
  }
  public setExpandedCommit(value: ExpandedCommit | null) {
    this.expandedCommit = value;
  }
  public getViewElem(): HTMLElement {
    return this.viewElem;
  }
  public getControlsElem(): HTMLElement {
    return this.controlsElem;
  }
  public getTableElem(): HTMLElement {
    return this.tableElem;
  }
  public getFooterElem(): HTMLElement {
    return this.footerElem;
  }
  public getRefreshBtnElem(): HTMLElement {
    return this.refreshBtnElem;
  }
  public getGitConfig(): GG.GitRepoConfig | null {
    return this.gitConfig;
  }
  public setRenderedGitBranchHead(value: string | null) {
    this.renderedGitBranchHead = value;
  }
  public isRefreshInProgress(): boolean {
    return this.currentRepoRefreshState.inProgress;
  }

  public setCurrentRepo(repo: string) {
    this.currentRepo = repo;
  }
  public setCurrentBranches(branches: string[] | null) {
    this.currentBranches = branches;
  }
  public setMaxCommits(max: number) {
    this.maxCommits = max;
  }
  public setAvatars(avatars: AvatarImageCollection) {
    this.avatars = avatars;
  }
  public setGitConfig(config: GG.GitRepoConfig | null) {
    ...
    this.tableElem.addEventListener('contextmenu', (e: Event) => {
      ...
      if ((eventElem = eventTarget.closest('.gitRef')) !== null) {
        ...
        if (eventElem.classList.contains(CLASS_REF_STASH)) {
          ...
          actions = buildTagContextMenuActions(
            this,
